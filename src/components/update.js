...
const Update = () => {
    ...
    const fetchingdata = async () => {
        const response = await fetch(`https://bk-posts-first-edit.vercel.app/api/user/getusers/${id}`)
    ...
    const submitHandler=async (e)=>{
        e.preventDefault();
        const response=await fetch(`https://bk-posts-first-edit.vercel.app/api/user/updateuser/${id}`,{
            method:"PATCH",
            headers:{
